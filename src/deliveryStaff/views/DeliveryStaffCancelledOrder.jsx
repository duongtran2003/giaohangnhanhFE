...
export default function DeliveryStaffCancelledOrder() {
  ...
  const fetchData = async (queryString) => {
    try {
      ...
      const response =
        await orderApi.getDeliveryStaffCancelledOrder(queryString);
  ...
  return (
    <div className="p-8">
      <div className="mb-4 text-lg font-medium text-left">Đơn hàng đã hủy</div>
