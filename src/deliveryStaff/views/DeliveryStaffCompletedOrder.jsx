...
export default function DeliveryStaffCompletedOrder() {
  ...
  const fetchData = async (queryString) => {
    try {
      ...
      const response =
        await orderApi.getDeliveryStaffCompletedOrder(queryString);
  ...
  return (
    <div className="p-8">
      <div className="mb-4 text-lg font-medium text-left">Đơn hàng đã xong</div>
          ...
          <table className="text-sm min-w-fit w-fit">
            <thead className="bg-gray-900 text-white">
              <tr>
                ...
                <th className="px-3 py-4 text-left max-w-[180px] min-w-[180px]">
                  Hành động
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              {tableData.map((order, index) => (
                ...
                >
                  ...
                  <td className="px-2 py-3 max-w-[180px] min-w-[180px]">
